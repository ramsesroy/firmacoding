...
```env
NEXT_PUBLIC_AI_WEBHOOK_URL=http://207.180.211.243:5678/webhook/generar-firma
```

**Nota:** Si no se configura esta variable, se usará la URL por defecto del webhook (IP directa para evitar bloqueos de Hostinger).
