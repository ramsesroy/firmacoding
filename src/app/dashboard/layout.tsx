    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      >
        ...
        <nav className="mt-8">
          <button
            onClick={toggleTheme}
            className="w-full flex items-center gap-3 px-6 py-3 text-gray-700 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-gray-700 hover:text-indigo-600 dark:hover:text-indigo-400 transition"
          >
            {theme === "dark" ? (
              <>
